...
| **🃏 Flashcards** | 3D flip flashcards supporting Kana subsets, Vocabulary, and Survival Phrases with Shuffle mode, mistake review, and mastery counters. |
| **⚡ Active Study** | 3-pillar hub: Kana transliteration (with Hiragana/Katakana/Both filters, virtual keyboard, Enter navigation), interactive survival Phrases Studio, and guided N5 Story Reader. |

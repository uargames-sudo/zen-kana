  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20 xl:pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 zen-card p-5 sm:p-6 border-2 border-zen-surface-high dark:border-zen-dark-border bg-white dark:bg-zen-dark-surface-high flex flex-col justify-between items-center text-center shadow-zen-lg dark:shadow-zen-dark-lg rounded-3xl">
          <div className="w-full flex justify-between items-center text-xs">
            <span className="px-3 py-1 rounded-full bg-zen-surface-container dark:bg-zen-dark-surface font-semibold text-zen-text-muted dark:text-zen-dark-text-muted">
          ...
          <div className="w-full mt-3 flex items-center bg-zen-surface-container/60 dark:bg-zen-dark-surface p-1 rounded-xl border border-zen-border/40 dark:border-zen-dark-border text-xs font-bold">
            <button
              type="button"
              onClick={() => setActiveStepTab('guide')}
              className={`flex-1 py-1.5 rounded-lg transition-all flex items-center justify-center gap-1 ${
                activeStepTab === 'guide'
                  ? 'bg-white dark:bg-zen-dark-surface-high text-zen-primary dark:text-zen-dark-primary shadow-sm'
          ...
          {activeStepTab === 'guide' ? (
            <div className="my-auto py-4 w-full flex flex-col items-center">
              <div className="relative w-48 h-48 sm:w-52 sm:h-52 rounded-2xl bg-zen-surface-container/30 dark:bg-zen-dark-surface border border-dashed border-zen-border/60 dark:border-zen-dark-border flex items-center justify-center">
                {/* Cross Grid Lines */}
                <div className="absolute inset-0 pointer-events-none flex flex-col justify-center items-center">
                  <div className="w-full h-px bg-zen-primary-light/20 dark:bg-zen-dark-border/40" />
                  <div className="h-full w-px bg-zen-primary-light/20 dark:bg-zen-dark-border/40 absolute" />
                </div>

                {/* Main Kana Glyph */}
                <span className="font-kana font-bold text-8xl sm:text-9xl text-zen-primary dark:text-white select-none leading-none">
                  {char}
                </span>
              ...
              <button
                ...
                className="mt-2 text-[11px] font-semibold text-zen-text-muted dark:text-zen-dark-text-muted hover:text-zen-primary dark:hover:text-zen-dark-primary transition-colors flex items-center gap-1"
              >
            ...
            <div className="my-auto py-3 w-full space-y-2 text-left">
              ...
              <div className="space-y-2 max-h-56 overflow-y-auto pr-1">
                {stepsList.map((step, sIdx) => (
                  ...
                  >
                    <span className="w-5 h-5 rounded-full bg-zen-primary dark:bg-zen-dark-primary text-white dark:text-zen-dark-on-primary font-bold text-[11px] flex items-center justify-center shrink-0 mt-0.5">
                      {sIdx + 1}
                    </span>
        ...
        <div className="md:col-span-7 zen-card p-5 sm:p-6 border-2 border-zen-surface-high dark:border-zen-dark-border flex flex-col items-center justify-between relative bg-white dark:bg-zen-dark-surface overflow-hidden shadow-zen-lg dark:shadow-zen-dark-lg rounded-3xl">
              ...
              <div className="absolute inset-0 pointer-events-none flex items-center justify-center select-none">
                ...
                {showStrokeNumbers && strokeInfo.markers?.map((marker, mIdx) => (
                  <div
                    ...
                    style={{ left: `${marker.x}%`, top: `${marker.y}%` }}
                    className="absolute -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-5 h-5 rounded-full bg-rose-500/80 text-white font-bold text-[10px] shadow-sm pointer-events-none select-none"
                  >
                    <span>{marker.num}</span>
                  </div>
                ))}

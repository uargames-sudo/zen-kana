        ...
        <div className="fixed bottom-20 sm:bottom-6 left-3 right-3 sm:left-1/2 sm:-translate-x-1/2 sm:w-full sm:max-w-xl z-30 animate-fade-in">
          <div className="zen-card p-3 sm:p-4 rounded-2xl border-2 border-zen-primary/40 dark:border-zen-dark-primary/50 bg-white/95 dark:bg-zen-dark-surface/95 backdrop-blur-md shadow-2xl flex items-center justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4 min-w-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 shrink-0 rounded-2xl bg-zen-primary dark:bg-zen-dark-primary text-white dark:text-zen-dark-on-primary flex items-center justify-center font-kana text-2xl sm:text-3xl font-bold shadow-zen-sm">
                {selectedKana.k}
              </div>
              <div className="min-w-0">
                ...
                <div className="text-xs text-zen-text-muted dark:text-zen-dark-text-muted flex items-center gap-1.5 mt-0.5 truncate">
                  <Info className="w-3.5 h-3.5 text-zen-secondary dark:text-zen-dark-secondary shrink-0" />
                  <span className="truncate">
                    {t('table.exampleWord')}: <strong className="text-zen-text dark:text-zen-dark-text font-medium">{getKanaExample(selectedKana.k, lang)}</strong>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                aria-label="Riproduci pronuncia audio"
                className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-zen-primary dark:bg-zen-dark-primary hover:bg-zen-primary-dark dark:hover:bg-zen-dark-primary-hover text-white dark:text-zen-dark-on-primary font-bold text-xs flex items-center gap-1.5 shadow-zen-sm transition-transform active:scale-95"
              >
              ...
              <button
                ...
                className="p-2 rounded-xl text-zen-text-muted dark:text-zen-dark-text-muted hover:text-zen-text dark:hover:text-zen-dark-text hover:bg-zen-surface-container dark:hover:bg-zen-dark-bg/60 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>

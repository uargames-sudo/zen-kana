...
export const translations = {
  it: {
    ...
    activeStudy: {
      ...
      contentAllKana: 'Tutto il Sillabario (104+ Kana)',
      contentBasic: 'Solo Base (46 Gojūon)',
      contentDakuten: 'Dakuten & Handakuten (25)',
      contentYoon: 'Yōon / Combinazioni (33)',
    ...
    puzzle: {
      ...
      categoryLabel: '3. Tipo di Contenuto',
      catVocab: 'Vocabolario',
      catSyllables: 'Tutto il Sillabario',
      catBasic: 'Solo Base (46)',
      catDakutenYoon: 'Dakuten & Yōon',
      scriptFilterLabel: '4. Sistema di Scrittura',
      filterAll: 'Tutti (Hira + Kata)',
      wordCountLabel: '5. Numero di Domande',
      wordCountAll: 'Tutte',
      wordCountSuffix: 'parole',
      startBtn: 'Inizia Partita',
      exit: 'Esci',
      wordCounter: 'Parola',
      slotsLabel: 'Caselle Parola',
      availableTilesLabel: 'Tessere Disponibili',
      revealChoicesBtn: 'Mostra Scelte',
      revealChoicesDesc: 'Tocca per scoprire le tessere disponibili',
  ...
  en: {
    ...
    activeStudy: {
      ...
      contentAllKana: 'All Syllabary (104+ Kana)',
      contentBasic: 'Basic Only (46 Gojūon)',
      contentDakuten: 'Dakuten & Handakuten (25)',
      contentYoon: 'Yōon / Combinations (33)',
    ...
    puzzle: {
      ...
      categoryLabel: '3. Content Type',
      catVocab: 'Vocabulary',
      catSyllables: 'All Syllabary',
      catBasic: 'Basic Only (46)',
      catDakutenYoon: 'Dakuten & Yōon',
      scriptFilterLabel: '4. Writing System',
      filterAll: 'All (Hira + Kata)',
      wordCountLabel: '5. Number of Questions',
      wordCountAll: 'All',
      wordCountSuffix: 'items',
      startBtn: 'Start Puzzle',
      exit: 'Exit',
      wordCounter: 'Word',
      slotsLabel: 'Word Slots',
      availableTilesLabel: 'Available Tiles',
      revealChoicesBtn: 'Show Choices',
      revealChoicesDesc: 'Tap to reveal available syllable tiles',
